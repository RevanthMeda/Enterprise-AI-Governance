...
import { Bot, ChevronLeft, Cpu, Fingerprint, PlugZap, ShieldAlert, Sparkles } from "lucide-react";
    ...
    <div className="space-y-6 p-6 max-w-6xl mx-auto" data-testid="page-connect-ai-application">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="space-y-2">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Create a draft AI Registry record and a derived risk assessment from the application manifest you receive alongside SDK or API-key onboarding.
            </p>
            {typeof window !== "undefined" && new URLSearchParams(window.location.search).get("source") === "sdk" ? (
              <p className="text-sm text-muted-foreground">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Badge variant="outline">Derived risk assessment</Badge>
      ...
      <div className="grid gap-6 xl:grid-cols-[1.25fr_0.75fr]">
        <Card>
          <CardHeader>
            <CardTitle>Application manifest</CardTitle>
            <CardDescription>
              This is the minimum defensible input set required to classify a connected AI application. An API key alone is not enough to infer business purpose or regulatory impact.
            </CardDescription>
          </CardHeader>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-2 text-sm text-muted-foreground">
              <p>1. Creates a draft AI system in the registry.</p>
              <p>2. Derives a risk assessment using the existing classifier.</p>
              <p>3. Preserves future reassessment history in the normal assessment table.</p>
              <p>4. Leaves telemetry policy and runtime controls intact.</p>
            </CardContent>
          </Card>
